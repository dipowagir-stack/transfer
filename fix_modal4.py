...
# 5. Conditional Render (regex replace the first occurrence of loading ternary branch)
pattern = re.compile(r'          \) : \(\n          <div className="space-y-4">')
replacement = '          ) : activeTab === \'EVIDENCE\' ? (\n          <div className="space-y-4">'
...
content = pattern2.sub(scoring_ui + '\n        </div>', content, count=1)

# 6. Hide old finalize in Evidence view
content = content.replace(
